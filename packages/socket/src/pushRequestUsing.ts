...
const onError = (absintheSocket: AbsintheSocket, notifier: Notifier) => (
  errorMessage: string,
): AbsintheSocket => abortNotifier(absintheSocket, notifier, createRequestError(errorMessage));

const getNotifierPushHandler = (
